...
typedef struct pandemonium_gdnative_core_api_struct {
	...
	const pandemonium_variant *(*pandemonium_typed_array_operator_index_const)(const pandemonium_typed_array *p_self, const pandemonium_int p_idx);
	pandemonium_bool (*pandemonium_typed_array_set)(pandemonium_typed_array *p_self, const pandemonium_int p_idx, const pandemonium_variant *p_value);
	pandemonium_variant (*pandemonium_typed_array_get)(const pandemonium_typed_array *p_self, const pandemonium_int p_idx);
	pandemonium_int (*pandemonium_typed_array_size)(const pandemonium_typed_array *p_self);
	pandemonium_bool (*pandemonium_typed_array_empty)(const pandemonium_typed_array *p_self);
	...
	pandemonium_bool (*pandemonium_typed_array_append_array)(pandemonium_typed_array *p_self, const pandemonium_typed_array *p_typed_array);
	pandemonium_bool (*pandemonium_typed_array_append_from)(pandemonium_typed_array *p_self, const pandemonium_variant *p_array);
	void (*pandemonium_typed_array_resize)(pandemonium_typed_array *p_self, const pandemonium_int p_size);
	pandemonium_bool (*pandemonium_typed_array_insert)(pandemonium_typed_array *p_self, const pandemonium_int p_pos, const pandemonium_variant *p_value);
	void (*pandemonium_typed_array_remove)(pandemonium_typed_array *p_self, const pandemonium_int p_idx);
	pandemonium_bool (*pandemonium_typed_array_fill)(pandemonium_typed_array *p_self, const pandemonium_variant *p_value);
	pandemonium_variant (*pandemonium_typed_array_front)(const pandemonium_typed_array *p_self);
	pandemonium_variant (*pandemonium_typed_array_back)(const pandemonium_typed_array *p_self);
	void (*pandemonium_typed_array_sort)(pandemonium_typed_array *p_self);
	void (*pandemonium_typed_array_sort_custom)(pandemonium_typed_array *p_self, pandemonium_object *p_obj, const pandemonium_string *p_func);
	void (*pandemonium_typed_array_shuffle)(pandemonium_typed_array *p_self);
	pandemonium_int (*pandemonium_typed_array_bsearch)(pandemonium_typed_array *p_self, const pandemonium_variant *p_value, const pandemonium_bool p_before);
	pandemonium_int (*pandemonium_typed_array_bsearch_custom)(pandemonium_typed_array *p_self, const pandemonium_variant *p_value, pandemonium_object *p_obj, const pandemonium_string *p_func, const pandemonium_bool p_before);
	void (*pandemonium_typed_array_invert)(pandemonium_typed_array *p_self);
	pandemonium_int (*pandemonium_typed_array_find)(const pandemonium_typed_array *p_self, const pandemonium_variant *p_what);
	pandemonium_int (*pandemonium_typed_array_find_from)(const pandemonium_typed_array *p_self, const pandemonium_variant *p_what, const pandemonium_int p_from);
	pandemonium_int (*pandemonium_typed_array_rfind)(const pandemonium_typed_array *p_self, const pandemonium_variant *p_what);
	pandemonium_int (*pandemonium_typed_array_rfind_from)(const pandemonium_typed_array *p_self, const pandemonium_variant *p_what, const pandemonium_int p_from);
	pandemonium_int (*pandemonium_typed_array_find_last)(const pandemonium_typed_array *p_self, const pandemonium_variant *p_what);
	pandemonium_int (*pandemonium_typed_array_count)(const pandemonium_typed_array *p_self, const pandemonium_variant *p_value);
	pandemonium_bool (*pandemonium_typed_array_has)(const pandemonium_typed_array *p_self, const pandemonium_variant *p_value);
	void (*pandemonium_typed_array_erase)(pandemonium_typed_array *p_self, const pandemonium_variant *p_value);
	pandemonium_bool (*pandemonium_typed_array_push_front)(pandemonium_typed_array *p_self, const pandemonium_variant *p_value);
	pandemonium_variant (*pandemonium_typed_array_pop_back)(pandemonium_typed_array *p_self);
	pandemonium_variant (*pandemonium_typed_array_pop_front)(pandemonium_typed_array *p_self);
	pandemonium_variant (*pandemonium_typed_array_pop_at)(pandemonium_typed_array *p_self, pandemonium_int p_pos);
	pandemonium_typed_array (*pandemonium_typed_array_duplicate)(const pandemonium_typed_array *p_self);
	pandemonium_typed_array (*pandemonium_typed_array_duplicate_deep)(const pandemonium_typed_array *p_self, const pandemonium_bool p_deep);
	pandemonium_typed_array (*pandemonium_typed_array_slice)(const pandemonium_typed_array *p_self, const pandemonium_int p_begin, const pandemonium_int p_end);
	pandemonium_typed_array (*pandemonium_typed_array_slice_step)(const pandemonium_typed_array *p_self, const pandemonium_int p_begin, const pandemonium_int p_end, const pandemonium_int p_step);
	pandemonium_typed_array (*pandemonium_typed_array_slice_step_deep)(const pandemonium_typed_array *p_self, const pandemonium_int p_begin, const pandemonium_int p_end, const pandemonium_int p_step, const pandemonium_bool p_deep);
	pandemonium_variant (*pandemonium_typed_array_min)(const pandemonium_typed_array *p_self);
	pandemonium_variant (*pandemonium_typed_array_max)(const pandemonium_typed_array *p_self);
	pandemonium_string (*pandemonium_typed_array_get_typename_string)(const pandemonium_typed_array *p_self);
	pandemonium_int (*pandemonium_typed_array_get_variant_type)(const pandemonium_typed_array *p_self);
	void (*pandemonium_typed_array_set_variant_type)(pandemonium_typed_array *p_self, const pandemonium_int p_variant_type);
	pandemonium_string_name (*pandemonium_typed_array_get_object_class_name)(const pandemonium_typed_array *p_self);
	void (*pandemonium_typed_array_set_object_class_name)(pandemonium_typed_array *p_self, const pandemonium_string_name *p_object_type_name);
	void (*pandemonium_typed_array_set_type_from_name)(pandemonium_typed_array *p_self, const pandemonium_string_name *p_type_name);
	void (*pandemonium_typed_array_set_type_from_variant)(pandemonium_typed_array *p_self, const pandemonium_variant *p_variant);
	void (*pandemonium_typed_array_set_type_from_array_element)(pandemonium_typed_array *p_self, const pandemonium_variant *p_array);
	void (*pandemonium_typed_array_set_type_from)(pandemonium_typed_array *p_self, const pandemonium_typed_array *p_array);
	pandemonium_bool (*pandemonium_typed_array_validate_type_name)(const pandemonium_typed_array *p_self, const pandemonium_string_name *p_type_name);
	pandemonium_bool (*pandemonium_typed_array_validate_object_type_name)(const pandemonium_typed_array *p_self, const pandemonium_string_name *p_type_name);
	pandemonium_bool (*pandemonium_typed_array_can_take_variant)(const pandemonium_typed_array *p_self, const pandemonium_variant *p_value);
	void (*pandemonium_typed_array_new)(pandemonium_typed_array *r_dest);
	void (*pandemonium_typed_array_new_copy)(pandemonium_typed_array *r_dest, const pandemonium_typed_array *p_src);
	void (*pandemonium_typed_array_new_pool_byte_array)(pandemonium_typed_array *r_dest, const pandemonium_pool_byte_array *p_pba);
	void (*pandemonium_typed_array_new_pool_int_array)(pandemonium_typed_array *r_dest, const pandemonium_pool_int_array *p_pia);
	void (*pandemonium_typed_array_new_pool_real_array)(pandemonium_typed_array *r_dest, const pandemonium_pool_real_array *p_pra);
	void (*pandemonium_typed_array_new_pool_string_array)(pandemonium_typed_array *r_dest, const pandemonium_pool_string_array *p_psa);
	void (*pandemonium_typed_array_new_pool_vector2_array)(pandemonium_typed_array *r_dest, const pandemonium_pool_vector2_array *p_pv2a);
	void (*pandemonium_typed_array_new_pool_vector2i_array)(pandemonium_typed_array *r_dest, const pandemonium_pool_vector2i_array *p_pv2a);
	void (*pandemonium_typed_array_new_pool_vector3_array)(pandemonium_typed_array *r_dest, const pandemonium_pool_vector3_array *p_pv3a);
	void (*pandemonium_typed_array_new_pool_vector3i_array)(pandemonium_typed_array *r_dest, const pandemonium_pool_vector3i_array *p_pv3a);
	void (*pandemonium_typed_array_new_pool_vector4_array)(pandemonium_typed_array *r_dest, const pandemonium_pool_vector4_array *p_pv3a);
	void (*pandemonium_typed_array_new_pool_vector4i_array)(pandemonium_typed_array *r_dest, const pandemonium_pool_vector4i_array *p_pv3a);
	void (*pandemonium_typed_array_new_pool_color_array)(pandemonium_typed_array *r_dest, const pandemonium_pool_color_array *p_pca);
	void (*pandemonium_typed_array_destroy)(pandemonium_typed_array *p_self);
	const pandemonium_variant (*pandemonium_packed_typed_array_operator_index_const)(const pandemonium_packed_typed_array *p_self, const pandemonium_int p_idx);
	void (*pandemonium_packed_typed_array_set)(pandemonium_packed_typed_array *p_self, const pandemonium_int p_idx, const pandemonium_variant *p_value);
	pandemonium_variant (*pandemonium_packed_typed_array_get)(const pandemonium_packed_typed_array *p_self, const pandemonium_int p_idx);
	pandemonium_int (*pandemonium_packed_typed_array_size)(const pandemonium_packed_typed_array *p_self);
	pandemonium_bool (*pandemonium_packed_typed_array_empty)(const pandemonium_packed_typed_array *p_self);
	...
	pandemonium_bool (*pandemonium_packed_typed_array_append)(pandemonium_packed_typed_array *p_self, const pandemonium_variant *p_value);
	pandemonium_bool (*pandemonium_packed_typed_array_append_array)(pandemonium_packed_typed_array *p_self, const pandemonium_packed_typed_array *p_packed_typed_array);
	pandemonium_bool (*pandemonium_packed_typed_array_append_from)(pandemonium_packed_typed_array *p_self, const pandemonium_variant *p_array);
	void (*pandemonium_packed_typed_array_resize)(pandemonium_packed_typed_array *p_self, const pandemonium_int p_size);
	pandemonium_bool (*pandemonium_packed_typed_array_insert)(pandemonium_packed_typed_array *p_self, const pandemonium_int p_pos, const pandemonium_variant *p_value);
	void (*pandemonium_packed_typed_array_remove)(pandemonium_packed_typed_array *p_self, const pandemonium_int p_idx);
	pandemonium_bool (*pandemonium_packed_typed_array_fill)(pandemonium_packed_typed_array *p_self, const pandemonium_variant *p_value);
	pandemonium_variant (*pandemonium_packed_typed_array_front)(const pandemonium_packed_typed_array *p_self);
	pandemonium_variant (*pandemonium_packed_typed_array_back)(const pandemonium_packed_typed_array *p_self);
	void (*pandemonium_packed_typed_array_sort)(pandemonium_packed_typed_array *p_self);
	void (*pandemonium_packed_typed_array_sort_custom)(pandemonium_packed_typed_array *p_self, pandemonium_object *p_obj, const pandemonium_string *p_func);
	void (*pandemonium_packed_typed_array_shuffle)(pandemonium_packed_typed_array *p_self);
	pandemonium_int (*pandemonium_packed_typed_array_bsearch)(pandemonium_packed_typed_array *p_self, const pandemonium_variant *p_value, const pandemonium_bool p_before);
	pandemonium_int (*pandemonium_packed_typed_array_bsearch_custom)(pandemonium_packed_typed_array *p_self, const pandemonium_variant *p_value, pandemonium_object *p_obj, const pandemonium_string *p_func, const pandemonium_bool p_before);
	void (*pandemonium_packed_typed_array_invert)(pandemonium_packed_typed_array *p_self);
	pandemonium_int (*pandemonium_packed_typed_array_find)(const pandemonium_packed_typed_array *p_self, const pandemonium_variant *p_what);
	pandemonium_int (*pandemonium_packed_typed_array_find_from)(const pandemonium_packed_typed_array *p_self, const pandemonium_variant *p_what, const pandemonium_int p_from);
	pandemonium_int (*pandemonium_packed_typed_array_rfind)(const pandemonium_packed_typed_array *p_self, const pandemonium_variant *p_what);
	pandemonium_int (*pandemonium_packed_typed_array_rfind_from)(const pandemonium_packed_typed_array *p_self, const pandemonium_variant *p_what, const pandemonium_int p_from);
	pandemonium_int (*pandemonium_packed_typed_array_find_last)(const pandemonium_packed_typed_array *p_self, const pandemonium_variant *p_what);
	pandemonium_int (*pandemonium_packed_typed_array_count)(const pandemonium_packed_typed_array *p_self, const pandemonium_variant *p_value);
	pandemonium_bool (*pandemonium_packed_typed_array_has)(const pandemonium_packed_typed_array *p_self, const pandemonium_variant *p_value);
	void (*pandemonium_packed_typed_array_erase)(pandemonium_packed_typed_array *p_self, const pandemonium_variant *p_value);
	pandemonium_bool (*pandemonium_packed_typed_array_push_front)(pandemonium_packed_typed_array *p_self, const pandemonium_variant *p_value);
	pandemonium_variant (*pandemonium_packed_typed_array_pop_back)(pandemonium_packed_typed_array *p_self);
	pandemonium_variant (*pandemonium_packed_typed_array_pop_front)(pandemonium_packed_typed_array *p_self);
	pandemonium_variant (*pandemonium_packed_typed_array_pop_at)(pandemonium_packed_typed_array *p_self, pandemonium_int p_pos);
	pandemonium_packed_typed_array (*pandemonium_packed_typed_array_duplicate)(const pandemonium_packed_typed_array *p_self);
	pandemonium_packed_typed_array (*pandemonium_packed_typed_array_duplicate_deep)(const pandemonium_packed_typed_array *p_self, const pandemonium_bool p_deep);
	pandemonium_packed_typed_array (*pandemonium_packed_typed_array_slice)(const pandemonium_packed_typed_array *p_self, const pandemonium_int p_begin, const pandemonium_int p_end);
	pandemonium_packed_typed_array (*pandemonium_packed_typed_array_slice_step)(const pandemonium_packed_typed_array *p_self, const pandemonium_int p_begin, const pandemonium_int p_end, const pandemonium_int p_step);
	pandemonium_packed_typed_array (*pandemonium_packed_typed_array_slice_step_deep)(const pandemonium_packed_typed_array *p_self, const pandemonium_int p_begin, const pandemonium_int p_end, const pandemonium_int p_step, const pandemonium_bool p_deep);
	pandemonium_variant (*pandemonium_packed_typed_array_min)(const pandemonium_packed_typed_array *p_self);
	pandemonium_variant (*pandemonium_packed_typed_array_max)(const pandemonium_packed_typed_array *p_self);
	...
	void (*pandemonium_packed_typed_array_set_type_from_variant)(pandemonium_packed_typed_array *p_self, const pandemonium_variant *p_variant);
	void (*pandemonium_packed_typed_array_set_type_from_array_element)(pandemonium_packed_typed_array *p_self, const pandemonium_variant *p_array);
	void (*pandemonium_packed_typed_array_set_type_from)(pandemonium_packed_typed_array *p_self, const pandemonium_packed_typed_array *p_array);
	pandemonium_bool (*pandemonium_packed_typed_array_validate_type_name)(const pandemonium_packed_typed_array *p_self, const pandemonium_string_name *p_type_name);
	pandemonium_bool (*pandemonium_packed_typed_array_validate_object_type_name)(const pandemonium_packed_typed_array *p_self, const pandemonium_string_name *p_type_name);
	pandemonium_bool (*pandemonium_packed_typed_array_can_take_variant)(const pandemonium_packed_typed_array *p_self, const pandemonium_variant *p_value);
	void (*pandemonium_packed_typed_array_new)(pandemonium_packed_typed_array *r_dest);
	void (*pandemonium_packed_typed_array_new_copy)(pandemonium_packed_typed_array *r_dest, const pandemonium_packed_typed_array *p_src);
	void (*pandemonium_packed_typed_array_new_pool_byte_array)(pandemonium_packed_typed_array *r_dest, const pandemonium_pool_byte_array *p_pba);
	void (*pandemonium_packed_typed_array_new_pool_int_array)(pandemonium_packed_typed_array *r_dest, const pandemonium_pool_int_array *p_pia);
	void (*pandemonium_packed_typed_array_new_pool_real_array)(pandemonium_packed_typed_array *r_dest, const pandemonium_pool_real_array *p_pra);
	void (*pandemonium_packed_typed_array_new_pool_string_array)(pandemonium_packed_typed_array *r_dest, const pandemonium_pool_string_array *p_psa);
	void (*pandemonium_packed_typed_array_new_pool_vector2_array)(pandemonium_packed_typed_array *r_dest, const pandemonium_pool_vector2_array *p_pv2a);
	void (*pandemonium_packed_typed_array_new_pool_vector2i_array)(pandemonium_packed_typed_array *r_dest, const pandemonium_pool_vector2i_array *p_pv2a);
	void (*pandemonium_packed_typed_array_new_pool_vector3_array)(pandemonium_packed_typed_array *r_dest, const pandemonium_pool_vector3_array *p_pv3a);
	void (*pandemonium_packed_typed_array_new_pool_vector3i_array)(pandemonium_packed_typed_array *r_dest, const pandemonium_pool_vector3i_array *p_pv3a);
	void (*pandemonium_packed_typed_array_new_pool_vector4_array)(pandemonium_packed_typed_array *r_dest, const pandemonium_pool_vector4_array *p_pv3a);
	void (*pandemonium_packed_typed_array_new_pool_vector4i_array)(pandemonium_packed_typed_array *r_dest, const pandemonium_pool_vector4i_array *p_pv3a);
	void (*pandemonium_packed_typed_array_new_pool_color_array)(pandemonium_packed_typed_array *r_dest, const pandemonium_pool_color_array *p_pca);
	void (*pandemonium_packed_typed_array_destroy)(pandemonium_packed_typed_array *p_self);
	...
	bool (*pandemonium_quaternion_set_shortest_arc)(pandemonium_quaternion *p_self, const pandemonium_vector3 *p_from, const pandemonium_vector3 *p_to);
	...
	uint64_t (*pandemonium_string_to_uint64)(const pandemonium_string *p_self);
