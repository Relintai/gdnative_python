...
class VariantType(IntFlag):
    ...
    TYPED_ARRAY = pandemonium_variant_type.PANDEMONIUM_VARIANT_TYPE_TYPED_ARRAY
    PACKED_TYPED_ARRAY = pandemonium_variant_type.PANDEMONIUM_VARIANT_TYPE_PACKED_TYPED_ARRAY
